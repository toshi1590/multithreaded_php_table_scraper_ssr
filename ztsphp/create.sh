...

{
  ...
  echo "    <link rel=\"stylesheet\" href=\"http://localhost:8001/index.css\">"
  echo "  </head>"
  echo "  <body class=\"m-1\">"
  ...
  echo "    <script type=\"text/javascript\" src=\"http://localhost:8001/paginathing.js\"></script>"
  ...
  echo "    <script src=\"http://localhost:8001/background_colors.js\"></script>"
  ...
  echo "    <script src=\"http://localhost:8001/common_functions.js\"></script>"
  echo "    <script src=\"http://localhost:8001/result_table.js\"></script>"
  echo "    <script src=\"http://localhost:8001/chart.js\"></script>"
  echo "  </body>"
  echo "</html>"
} >> scraping.php
