...

{
  ...
  echo "    <link rel=\"stylesheet\" href=\"http://localhost:8001/ssr/index.css\">"
  echo "  </head>"
  echo "  <body class=\"m-1\">"
  ...
  echo "    <script type=\"text/javascript\" src=\"http://localhost:8001/ssr/paginathing.js\"></script>"
  ...
  echo "    <script src=\"http://localhost:8001/ssr/background_colors.js\"></script>"
  ...
  echo "    <script src=\"http://localhost:8001/ssr/common_functions.js\"></script>"
  echo "    <script src=\"http://localhost:8001/ssr/result_table.js\"></script>"
  echo "    <script src=\"http://localhost:8001/ssr/chart.js\"></script>"
  echo "  </body>"
  echo "</html>"
} >> scraping.php
